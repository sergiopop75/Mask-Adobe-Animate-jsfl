...
myStroke.color = "#332720";
myStroke.style = "solid"; 
myStroke.thickness = 1.5; 
myStroke.scaleType = "none";
...
an.getDocumentDOM().addNewRectangle({left:-184.3, top:-164.2, right:2072.3, bottom:1296.2}, 0);
...
// Set the blend mode
layer.setBlendModeAtFrame( tl.currentFrame, "Alpha" );
